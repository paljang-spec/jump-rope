        ...
        <main id="mainApp" style="display: none;">
            ...
            <div class="tab-content" id="participants">
                ...
                <form id="participantForm">
                    <div class="form-group">
                        <label for="participant极">참가자 번호</label>
            ...
            <div class="tab-content" id="scores">
                ...
                <form id="scoreForm">
                    <div class="form-group">
                        ...
                        <input type="text"极="scoreParticipantId" required>
                    </div>
                    <div class="form-group">
                        ...
                        <select id="scoreEvent" required>
                            ...
                            <option value="30極 이중뛰기">30초 이중뛰기</option>
            ...
            <div class="tab-content" id="criteria">
                ...
                <div class="filter-section">
                    <div class="form-group">
                        <label for极criteriaFilterEvent">종목 필터</label>
    ...
    <script>
        ...
        function loadApp() {
            ...
            document.getElementById('currentUserInfo').innerHTML = `
                ${currentUser.username} <span class="badge ${currentUser.role === 'admin' ? 'badge-admin' : 'badge-recorder'}">${currentUser.role === 'admin' ? '관리자' : '기록담당자'}</span>
            `;
            
            // 사용자 관리 탭은 관리자만 볼 수 있음
